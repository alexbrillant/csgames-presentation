...
import QuoteActions from '../Redux/QuotesRedux'
...
const mapStateToProps = (state) => {
  return {
    searchTerm: state.quotes.searchTerm
  }
}

const mapDispatchToProps = (dispatch) => {
  return {
    performSearch: (searchTerm) => dispatch(QuoteActions.search(searchTerm)),
    cancelSearch: () => dispatch(QuoteActions.cancelSearch())
  }
}
