...
import CirclesSquare from '../../App/Components/CirclesSquare'

const wrapper = shallow(<CirclesSquare />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('CirclesSquare Component')) // That the Component Text is included
})
